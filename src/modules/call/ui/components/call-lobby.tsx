...
const AllowBrowserPermissions = () => {
    return(
        <p className="text-sm">
            Please grant you browser a permission to access your camera and microphone.
        </p>
    )
}
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full bg-radial from-sidebar-accent to-sidebar">
            <div className="py-2 px-8 flex flex-1 items-center justify-center">
                <div className="flex flex-col items-center justify-center gap-y-3 bg-background rounded-lg p-5 shadow-sm">
